...
const authorizationRequest = '/auth/realms/loyertracker/protocol/openid-connect/auth?client_id=loyertracker-spa&redirect_uri=https%3A%2F%2Flocalhost%2F&response_type=code&scope=openid&prompt=login';
