...
> Le **`sha-27dce09d`** (EP-16 Sprint N+1 WhatsApp P0, déployé le 2026-07-24) est le
> **tag actif en staging**. Flyway **28/28**, smoke **63/0**, STG-ISOL-01 PASS avant/après,
> parcours WhatsApp réel vérifié de bout en bout (Sandbox Twilio). Aucune activation Production.
> La Production reste soumise à un Gate distinct.
>
