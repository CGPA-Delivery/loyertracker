...
> fonctionnel côté domaine Staging Resend (`HTTP 403`, domaine non vérifié) et webhook réel ; `RESEND_EMAIL_ENABLED=false` maintient le kill-switch
