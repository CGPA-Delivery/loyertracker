...
> **EP-17 / US-136 — audit accessibilité Lot 5 : preuve automatisée login Keycloak PASS, clôture toujours NO GO (2026-08-10T13:35:29Z).** La PR #431, SHA `1767be79567fa1257bd8bf196b475e8e6411708f`, a validé la CI complète, dont `Accessibilité E2E (Playwright + axe)` : stack Docker isolée, TLS `localhost` de confiance sans bypass, audit runtime du login Keycloak **1 passed (2.8s)**, artifact GitHub `9064684806` (SHA-256 `7549d5aef8e9f1f0e61bd29e0c0c327ad681c3406ca52be4436105b2c7256523`). Les corrections ciblées portent sur le contraste `.instruction`, le landmark principal et les `tabindex` positifs. Les réserves restent ouvertes pour les cinq autres flux Keycloak, l’authentification Angular réelle et la matrice manuelle clavier/focus/zoom/reflow/reduced-motion ; aucun Gate historique, Staging, Production, realm, URI de redirection ou secret persistant modifié. Références : `docs/cgpa/checklists/check-accessibility-01-ep17-us136.md`, `docs/cgpa/06-planification-agile/rapport-audit-accessibilite-ep17-us136-2026-08-10.md`.
