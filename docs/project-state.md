...
> **GO PO/CDO — cadrage US-125 / Gates 02A-04A autorisé, sans codage (2026-08-06).** Après clôture CDO de `1.16.0`, le PO choisit le sprint backlog produit suivant : EP-16 Sprint N+2 Lot B / **US-125** (interface de préférences et historique notifications). Décision limitée au cadrage UX/UI et à l'instruction Gate 04A : Gate 02A US-125 est déjà statué GO sous réserve, UXR-001 et DDS-LT-002→005 sont renseignés/acceptés, DSG-001 est instancié ; Gate 04A reste non instruit. Aucun codage Frontend, backend, migration, Staging, Production, secret, activation Twilio/SMS/WhatsApp ou EP-19 n'est autorisé. Décision : `docs/cgpa/06-planification-agile/cadrage-us125-gates-02a-04a.md`.
