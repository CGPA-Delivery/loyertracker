...
| DDS-LT-006 | Validation visuelle et contraste WCAG 2.2 AA des Design Tokens (US-129) | **Proposée** — 11/13 tokens conformes tels quels, 2 corrections de couleur proposées (`--lt-border-default`, `--lt-state-danger-strong`), 6 nouvelles catégories de tokens candidatées, validation Product Owner non obtenue | DSG-001 v0.1.0 | EP-17 (US-129, Lot 1) | Design Architect (Claude Code, désigné 2026-07-30) | 2026-08-01 | — |
