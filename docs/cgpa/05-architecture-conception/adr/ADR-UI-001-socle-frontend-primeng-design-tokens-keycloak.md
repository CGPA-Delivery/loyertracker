...
| Validateurs requis pour la mise en œuvre | Design Architect, Frontend Architect, DevSecOps Lead (nouvelle dépendance), Security Architect Keycloak — tous à désigner |
